...
from app.routers import admin, applications, consulting, health, manager, partner, partner_compat, storage
...
app.include_router(partner_compat.router, prefix="/api/consulting/partner", tags=["partner-web-compat"])
